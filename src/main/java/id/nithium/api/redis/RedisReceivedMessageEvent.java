...
public class RedisReceivedMessageEvent extends Event implements IRedisMessageReceivedEvent {
    ...
    public RedisReceivedMessageEvent(String channel, MessageTransferObject messageTransferObject) {
